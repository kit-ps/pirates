...
Client::Client(FastPIRParams params, seal::SecretKey secret_key)
{
    ...
    keygen = new seal::KeyGenerator(*context, secret_key);
...
seal::SecretKey Client::get_secret_key()
{
    return secret_key;
}

seal::SEALContext* Client::get_seal_context()
{
    return context;
}
